...
public class PagePlugin implements Interceptor {
    ...
    static ThreadLocal<PageParames> tp = new ThreadLocal<PageParames>();
    ...
    private String getPageSql(PageParames page, String sql) {
        ...
        switch (dialect) {
            ...
            case ORACLE:
                ...
                StringBuffer oracelSql = new StringBuffer();
                oracelSql.append("SELECT * FROM (SELECT ROW_.*, ROWNUM ROWNUM_ FROM (");
                oracelSql.append(" ");
                oracelSql.append(sql);
                oracelSql.append(" ");
                oracelSql.append(" ) ROW_ WHERE ROWNUM <= " + end + " ) WHERE ROWNUM_ > " + start);
                sqlBuffer = oracelSql;
                break;
        }
