...
public abstract class BaseView<Control> extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        int viewDefaultHeight = getViewDefaultHeight();
        int viewDefaultWidth = getViewDefaultWidth();
        ...
        Scene scene = new Scene(rootView, viewDefaultWidth, viewDefaultHeight);
